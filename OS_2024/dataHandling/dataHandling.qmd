...
[lintr](https://github.com/r-lib/lintr) is complementary to [the `{styler}` package](https://github.com/r-lib/styler) which automatically restyles code, eliminating some of the problems that [lintr](https://github.com/r-lib/lintr) can detect.
